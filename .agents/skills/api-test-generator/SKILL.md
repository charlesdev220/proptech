...
2. **Generar Plantilla Spring Boot (Integration Test):**
   Crea una prueba de integración con `@SpringBootTest` y `MockMvc` que valide todos los flujos de respuesta HTTP y compruebe los errores RFC 7807 para el backend.
